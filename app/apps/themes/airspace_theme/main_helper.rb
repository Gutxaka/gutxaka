module Themes::AirspaceTheme::MainHelper
  def self.included(klass)
    # klass.helper_method [:my_helper_method] rescue "" # here your methods accessible from views
  end

  def airspace_theme_settings(theme)
  ...
  def airspace_theme_on_install_theme(theme)
  ...
  def airspace_theme_on_uninstall_theme(theme)
  end
end
